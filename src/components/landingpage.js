    ...
    render() {
        return (
            <div className= "banner-text">
				<h1 style= {{fontWeight: "bold", paddingTop: "60px", backgroundColor: "white", fontFamily: "'Inter', sans-serif"}}>Hi, my name is Huy 'Jonny' Nguyen</h1>

				<h2 style= {{ color:"grey", fontFamily: "'Inter', sans-serif"}}>Building things for the web.</h2>

				<p style= {{ fontSize: "25px", paddingTop: "60px", width: "95%",backgroundColor: "white"}}>I am a student at Lamar University majoring in Computer Science Game Development. My expected graduation date is December 2021. My interest in web development started back in 2016 when I decided to try editing custom Tumblr themes — turns out hacking together a custom reblog button taught me a lot about HTML & CSS!</p>
