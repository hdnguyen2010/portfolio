    ...
    render() {
        return (
            <div className="projects-grid">
	    			...
	    			{/* Project 1 */}
	    			<Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
	    				<CardTitle style={{color: 'white', height: '176px', background:'url(/images/vit-prev.png) center / cover'}}>Vitamin-DB</CardTitle>
	    				<CardText>
	    					Lorem Ipsum is simply dummy text of the printing and typesetting industry.
	    				</CardText>
	    				<CardActions border>
	    				<Button href="https://www.youtube.com/watch?v=vEFQblKqqkI&feature=youtu.be" colored>Demo</Button>
	    				<Button href="https://github.com/hdnguyen2010/vitamin-db" colored>GitHub</Button>
	    				<Button href="http://vitamin-db.herokuapp.com/" colored>Website</Button>
	    				</CardActions>
	    				<CardMenu style={{color: '#fff'}}>
	    				</CardMenu>
	    			</Card>
